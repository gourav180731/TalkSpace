...
router.get("/muted", authMiddleware, c.getMutedChats);
router.get("/deleted", authMiddleware, c.getDeletedChats);
router.post("/delete", authMiddleware, c.deleteChat);
...
router.post("/lock/setup", authMiddleware, c.setupChatLock);
router.post("/lock/verify", authMiddleware, c.verifyChatLock);
router.post("/lock/remove", authMiddleware, c.removeChatLock);
